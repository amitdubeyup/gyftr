...
## 📝 About The Project
Custom software solution built with Express, MongoDB developed to address specific business requirements for Gyftr Integration Service.
...
1.  **Clone the repository**:
    ```bash
    git clone git@github.com:amitdubeyup/gyftr-integration-service.git
    ```
